  ...
  return (
    <ScrollView style={{ paddingTop: 50, backgroundColor: "#fff", flex: 1 }}>
      <View style={{ paddingHorizontal: 20 }}>
        ...
        <View style={{height: 110, width: '100%', borderRadius: 10,
                    borderWidth: 0.5, color: "gray", flexDirection: "row",}}>
            ...
            <View style={{flexDirection: "column", marginVertical: 21}}>
                ...
                <Text style={{fontSize: 18, fontWeight: "bold"}}>First Name Last Name</Text>
