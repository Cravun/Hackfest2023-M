...
import { StyleSheet, Text, TouchableOpacity, Linking, Button, ScrollView,View, Image } from "react-native";
    ...
    <ScrollView style={{ paddingTop: 50, flex: 1, }}>
      ...
      <View style={{width: "100%", justifyContent: "space-between",
          ...
          <View style={{ alignItems: "flex-end",}}>
                <Text style={{fontSize: 25, paddingBottom: 10, color:"#E1E1E1"}}>User Profile</Text>
            </View>
        ...
        <View
          style={{
            ...
            <View
          style={{
            height: 100, width: 100, borderRadius: 100, backgroundColor: "gray", marginTop: 10,
          }}/>
          <View style={{height: 22, width: 90, backgroundColor: "#DD4438",
                            borderRadius: 5, marginTop: 10}}>
                    <Text style={{textAlign:"center", fontSize: 12, 
                                color: "white",marginVertical: 2}}>
                        Blood Type: </Text>
                </View>
          <Text style={[styles1.setFontSizeThree, {paddingVertical: 5,fontWeight:"bold"}]}>
      ...
      <View style={{ flexDirection: "column", }}>
        <View style={{ width: "100%", height: 100, borderWidth: 0.3,
                      flexDirection: "row",}}>
          <View style={{height: 80, width: 80, borderRadius: 10, margin: 10,
      ...
      <Text style={{ fontSize: 20, paddingBottom: 10, paddingTop: 30, 
